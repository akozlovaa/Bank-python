...
class BankServiceManager:
    ...
    def find_bank_services_by_service_term(self, service_term_to_find: ServiceTerm):
        """
        ...
        >>> print(manager.find_bank_services_by_service_term(ServiceTerm.LONG_TERM))
        ['Monobank']
        >>> print(manager.find_bank_services_by_service_term(ServiceTerm.SHORT_TERM))
        ['BoA']
        >>> print(manager.find_bank_services_by_service_term(ServiceTerm.HOME_EQUITY))
        ['NBC']
        """
        result_services = []
        for service in self.bank_service_list:
            if service.service_term == service_term_to_find:
